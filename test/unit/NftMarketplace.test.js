...
!developmentChains.includes(network.name)
    ...
    : describe("NFT Marketplace Unit Tests", function () {
          let nftMarketplaceContract, nftMarketplace, basicNft, deployer, user
          ...
          beforeEach(async () => {
              ...
              nftMarketplaceContract = await ethers.getContract("NftMarketplace") // Returns a new connection to the NftMarketplace contract
